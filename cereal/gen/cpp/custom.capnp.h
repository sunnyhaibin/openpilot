...
CAPNP_DECLARE_SCHEMA(df500dea80610973);
CAPNP_DECLARE_SCHEMA(f60a0fdf0cff737a);
enum class EventName_f60a0fdf0cff737a: uint16_t {
  LKAS_ENABLE,
  LKAS_DISABLE,
...
CAPNP_DECLARE_ENUM(EventName, f60a0fdf0cff737a);
...
struct OnroadEventSP {
  ...
  class Builder;
  class Pipeline;
  typedef ::capnp::schemas::EventName_f60a0fdf0cff737a EventName;


  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(df500dea80610973, 1, 0)
    #if !CAPNP_LITE
